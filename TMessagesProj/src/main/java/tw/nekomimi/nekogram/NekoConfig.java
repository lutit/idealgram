...
public class NekoConfig {
    ...
    public static ConfigItem showUzbekAds = addConfig("showUzbekAds", configTypeBool, false);
    ...
    public static ConfigItem appleMode = addConfig("AppleMode", configTypeBool, false);
    ...
    public static boolean isHyperShamalaModeActive() {
        return hyperShamalaMode.Bool();
    }

    public static void toggleHyperShamalaMode() {
    ...
    public static boolean isUspdmpshmModeActive() {
        return uspdmpshmMode.Bool();
    }

    public static void toggleUspdmpshmMode() {
