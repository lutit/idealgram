...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static int nkbtnUzbekHub = 1014;
    public static int nkbtnUzbekXXX = 1015;
    public static int nkbtnLegends = 1016;
    public static int nkbtnUltraShamalaMode = 1017;
    public static int nkbtnHyperShamalaMode = 1018;
    public static int nkbtnUspdmpshmMode = 1019;
    public static int nkbtnEpsteinMode = 1020;
    ...
    private void resetItems() {
        ...
        if (NaConfig.INSTANCE.getDrawerItemShamala().Bool()) {
            ...
            CharSequence ultraShamalaLabel = NekoConfig.isUltraShamalaModeActive()
        ...
        boolean allahDurovEnabled = MessagesController.getGlobalMainSettings().getBoolean("allah_durov_enabled", false);
        CharSequence allahDurovLabel = allahDurovEnabled ? "Disable Allah Durov" : "Enable Allah Durov";
        items.add(new Item(nkbtnAllahDurov, allahDurovLabel, R.drawable.msg_policy));
        ...
        items.add(new Item(nkbtnNavalny, "НАВАЛЬНЫЙ LIVE", R.drawable.msg_help));
        items.add(new Item(nkbtnAidsTest, "Тест на СПИД (Быстрый)", R.drawable.msg_help));
        items.add(new Item(nkbtnFsbScan, "ЕСТЬ ЛИ В ЧАТЕ АГЕНТ ФСБ?", R.drawable.msg_policy));
...
//        items.add(new Item(13, LocaleController.getString(R.string.TelegramFeatures), helpIcon));
        ...
        boolean showOpenQuran = NaConfig.INSTANCE.getDrawerItemQuran().Bool();
        boolean showOpenBible = NaConfig.INSTANCE.getDrawerItemBible().Bool();
