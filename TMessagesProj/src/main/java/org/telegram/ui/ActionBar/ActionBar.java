...
public class ActionBar extends FrameLayout {
    ...
    public void setTitle(CharSequence value, Drawable rightDrawable) {
        ...
        if (titleTextView[0] != null) {
            boolean shouldShowTitle = value != null && !isSearchFieldVisible;
            titleTextView[0].setVisibility(shouldShowTitle ? VISIBLE : INVISIBLE);
            titleTextView[0].setText(lastTitle = titleWithCheck != null ? titleWithCheck : value);
